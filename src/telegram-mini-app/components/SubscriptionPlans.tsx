...
export const SubscriptionPlans = ({
  ...
  return (
    <div className="space-y-8 px-4 w-full max-w-full">
      <motion.div 
      ...
      >
        ...
        <p className="text-gray-600">Select a perfect plan for your needs 🚀</p>
      </motion.div>
        ...
        {plans.map((plan, planIndex) => (
          ...
          >
            ...
            {selectedPlan?.id === plan.id && (
              ...
              >
                <div className="bg-primary text-white font-medium w-full py-2 px-4 text-center rounded-lg transition-colors duration-300">
                  ✓ Selected
                </div>
              </motion.div>
            )}
