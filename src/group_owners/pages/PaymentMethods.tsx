...
const PaymentMethods = () => {
  ...
  // Show special UI when a group is selected
  if (isGroupSelected) {
    return (
        ...
        <Card className="border-amber-200 shadow-md bg-amber-50/30 overflow-hidden">
          <CardHeader className="pb-3 pt-6">
            <div className="flex items-center gap-2 mb-2">
              ...
              <CardTitle className="text-xl">Group Selected</CardTitle>
            </div>
            <CardDescription className="text-base text-amber-800">
              Payment methods can only be configured for individual communities, not groups.
            </CardDescription>
          </CardHeader>
          <CardContent className="pb-6">
            <p className="mb-6 text-amber-700">
              To configure payment methods, please select a specific community from the dropdown at the top of the page.
            </p>
            <div className="flex justify-center">
              <Button 
                ...
                onClick={() => {
                  document.querySelector('[class*="SelectTrigger"]')?.dispatchEvent(
      ...
      {!selectedCommunityId ? (
        <Card className="border-amber-200 shadow-md bg-amber-50/30 overflow-hidden">
          <CardHeader className="pb-3 pt-6">
            <div className="flex items-center gap-2 mb-2">
              <AlertCircle className="h-6 w-6 text-amber-500" />
              <CardTitle className="text-xl">No Community Selected</CardTitle>
            </div>
            <CardDescription className="text-base text-amber-800">
              Please select a community to manage payment methods
            </CardDescription>
          </CardHeader>
          <CardContent className="pb-6">
            <p className="mb-6 text-amber-700">
              To configure payment methods, please select a community from the dropdown at the top of the page.
            </p>
          </CardContent>
        </Card>
      ) : (
