...
export default function Index() {
  ...
  return <div className="min-h-screen flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            duration: 0.8
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                {user ? <>
                    {isAdmin ? <Button asChild size="lg" className="text-lg bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-md">
                        <Link to="/admin/dashboard" className="flex items-center">
                          <Shield className="mr-2 h-5 w-5" />
                          Admin Panel
                        </Link>
                      </Button> : <Button asChild size="lg" className="text-lg bg-indigo-600 hover:bg-indigo-700 rounded-xl shadow-md">
                    ...
                    {isAdmin && <Button asChild variant="outline" size="lg" className="text-lg border-indigo-200 hover:bg-indigo-50 rounded-xl">
                        <Link to="/dashboard" className="flex items-center">
      ...
      {/* Feature Sections */}
      <FeatureSection title="Start & Grow 🚀" description="Membify gives you everything you need to build a thriving paid Telegram community. You focus on great content and growth, and we handle everything else, from invites to permissions and more." features={managementFeatures} imageSrc="/lovable-uploads/922e3de0-b097-4b2c-8e97-32aa579d045a.png" imageAlt="Community Management Platform" bgColor="bg-white" />
      
      <FeatureSection title="Get Paid Globally 💸" description="Enhance convenience and streamline payments with a flexible wide range of options on Membify." features={paymentFeatures} imageSrc="/lovable-uploads/9ffe418a-ad3f-4a1c-9576-89f7129a1b8f.png" imageAlt="Global Payment Options" bgColor="bg-green-50" reversed={true} />
      
      <FeatureSection title="Monitor & Manage 📊" description="Built-in member management features like billing and community analytics make administration a breeze, while your activity feed lets you keep your finger on the pulse of your community." features={monitorFeatures} imageSrc="/lovable-uploads/1fe01199-01ba-4d5d-9d6e-88af5097a5f0.png" imageAlt="Analytics Dashboard" bgColor="bg-white" />
      
      <FeatureSection title="Unparalleled Support 🎧" description="Our Customer Success team offers reliable and dedicated support to help you grow your membership business." features={supportFeatures} imageSrc="/lovable-uploads/d7b82bfb-6189-40c0-8cba-643eb0c03b4c.png" imageAlt="Customer Support" bgColor="bg-amber-50" reversed={true} buttonText="Get started for free" />
