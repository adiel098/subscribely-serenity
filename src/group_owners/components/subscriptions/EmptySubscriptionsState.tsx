...
import { PackagePlus, SparklesIcon, Zap, Shield, Award } from "lucide-react";
      ...
      <Card className="border-2 border-dashed border-indigo-200 bg-gradient-to-r from-indigo-50/40 to-purple-50/40 p-8 rounded-xl shadow-sm overflow-hidden relative">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          <div className="bg-gradient-to-r from-indigo-100 to-indigo-200 p-4 rounded-full mb-6">
            <PackagePlus className="h-12 w-12 text-indigo-600" />
          </div>
          ...
          <p className="text-gray-600 max-w-md mb-8">
            Create your first subscription plan to start offering premium access to your community members.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-2xl mb-8">
            {[
              { 
                ...
                description: "Turn your community into a revenue stream" 
              },
              { 
                icon: <Shield className="h-6 w-6 text-purple-500" />, 
                title: "Exclusive Access",
                description: "Provide premium content to paying members" 
              },
              { 
                icon: <Award className="h-6 w-6 text-amber-500" />, 
                title: "Multiple Tiers",
                description: "Create various subscription levels" 
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
