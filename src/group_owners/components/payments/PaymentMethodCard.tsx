    ...
    <>
      ...
      >
        <Card className="relative h-full border hover:border-indigo-300 transition-all duration-300 shadow-md hover:shadow-lg group overflow-hidden bg-white">
          ...
          <CardHeader className="pb-2">
            <div className="flex justify-between items-start">
              <CardTitle className="flex items-center gap-2 text-xl">
                {imageSrc ? (
                  <div className="p-2 rounded-full bg-white shadow-sm flex items-center justify-center w-14 h-14">
                    <img src={imageSrc} alt={title} className="w-10 h-10 object-contain" />
                  </div>
                ) : (
                  <div className="p-2 rounded-full bg-indigo-100 text-indigo-600 w-14 h-14 flex items-center justify-center">
          ...
          <CardContent>
            <div className="flex justify-between items-center gap-4 p-4 rounded-lg bg-gray-50 border border-gray-100">
