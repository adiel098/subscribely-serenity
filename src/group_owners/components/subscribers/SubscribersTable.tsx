...
export const SubscribersTable = ({ subscribers, onEdit, onRemove }: SubscribersTableProps) => {
  ...
  const handleRemoveClick = (subscriber: Subscriber) => {
    setSelectedSubscriber(subscriber);
    setRemoveDialogOpen(true);
  };

  const handleConfirmRemove = async (subscriber: Subscriber) => {
    setIsRemoving(true);
    try {
      await onRemove(subscriber);
    } finally {
      setIsRemoving(false);
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        ...
                        <DropdownMenuItem
                          ...
                          onClick={() => handleRemoveClick(subscriber)}
                        >
