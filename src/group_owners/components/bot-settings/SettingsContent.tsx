...
export const SettingsContent = ({
  ...
  if (!settings) {
    return <div className="flex items-center justify-center h-[400px] bg-gray-50 rounded-lg border border-dashed border-gray-300">
  ...
  return <motion.div variants={containerVariants} initial="hidden" animate="visible">
      ...
      <div className="grid md:grid-cols-5 gap-6">
        <motion.div className="md:col-span-3" variants={itemVariants}>
          <Accordion type="single" collapsible value={expandedSection || undefined} onValueChange={value => setExpandedSection(value)} className="space-y-4">
            ...
            <BroadcastSection entityId={entityId || ""} entityType={entityType} />
          </Accordion>
        </motion.div>
