...
const PaymentMethods = () => {
  ...
  return <div className="container max-w-6xl space-y-4 animate-fade-in px-0 py-0">
      <PageHeader title="Payment Methods" description="Configure and manage payment gateways for all your communities and groups 💸" icon={<Zap />} />
