...
const Dashboard = () => {
  ...
  return <div className="space-y-6 pb-10 px-[21px] py-[12px]">
        ...
        <div className="md:col-span-6">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div className="md:col-span-4">
              <DashboardStats totalSubscribers={filteredSubscribers.length} activeSubscribers={activeSubscribers.length} inactiveSubscribers={inactiveSubscribers.length} totalRevenue={totalRevenue} avgRevenuePerSubscriber={avgRevenuePerSubscriber} conversionRate={conversionRate} timeRange={timeRangeLabel} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-4 mt-6">
        ...
        <div className="w-full lg:w-[32%] flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <AnalyticsOverview averageSubscriptionDuration={insights.averageSubscriptionDuration} mostPopularPlan={insights.mostPopularPlan} mostPopularPlanPrice={insights.mostPopularPlanPrice} mostActiveDay={insights.mostActiveDay} renewalRate={insights.renewalRate} />
          </div>
        </div>
      </div>
    </div>;
