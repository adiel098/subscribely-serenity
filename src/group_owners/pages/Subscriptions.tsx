  ...
  return <div className="space-y-6 py-6">
      ...
      duration: 0.4
        ...
        scale: 0.95
          ...
          <Button onClick={handleCreatePlan} className="bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 text-white shadow-md hover:shadow-lg transition-all duration-300 px-5 py-2.5 h-auto" type="button">
      ...
      {plans.length === 0 ? <motion.div initial={{
      opacity: 0,
      scale: 0.9
    }} animate={{
      opacity: 1,
      ...
      {selectedPlan && <EditPlanDialog isOpen={editDialogOpen} onOpenChange={setEditDialogOpen} editPlanData={{
      id: selectedPlan.id,
