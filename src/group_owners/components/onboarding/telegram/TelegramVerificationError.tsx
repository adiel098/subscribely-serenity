...
export const TelegramVerificationError: React.FC<TelegramVerificationErrorProps> = ({
  ...
  return (
    <motion.div
      ...
      className="mb-6"
    >
      <Alert className="border-red-100 bg-red-50 text-red-800">
        <AlertTriangle className="h-5 w-5 text-red-500" />
        <AlertTitle className="text-red-800 font-semibold text-lg flex items-center gap-2">
          Verification Failed
        </AlertTitle>
        <AlertDescription className="text-red-700">
          <p className="mt-2">We couldn't verify your Telegram group connection. Please make sure:</p>
          ...
          {errorCount > 3 && (
            <p className="mt-3 p-2 bg-red-100 rounded-md text-red-800 border border-red-200">
